                ...
                <div class="modal-body">
                    <div class="form-group col-md-12">
                        ...
                        <div v-if="estra.planeacion.requiere_evidencia==1">
                            <input type="checkbox" class="" id="requiere_evidencia" name="requiere_evidencia" v-bind:value="1" checked>
                        </div>
                        <div v-else>
                            <input type="checkbox" class="" id="requiere_evidencia" name="requiere_evidencia" v-bind:value="1">
                        </div>
