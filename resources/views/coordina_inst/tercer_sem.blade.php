...
@section('content')
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="tercero" role="tabpanel" aria-labelledby="tercero-tab">
                        ...
                        <div class="form-group row">
                            ...
                            <a class="btn btn-primary" data-toggle="modal" data-target="#myModal_3" style="background: #067a39;color: white">+</a>
                        </div>
    ...
    <div class="modal fade" id="myModal_3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form id="form-expe_3">
                        ...
                        <div style="display: none">
                            <input type="number" class="form-control"  id="id_semestre" name="id_semestre" value="3">
                            <input type="number" class="form-control"  id="id_estado" name="id_estado" value="0">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <a class="btn btn-primary" id="final_3" data-dismiss="modal" style="color: white">Agregar</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        $('#final_3').click(function(){
            var con= true;
            var datos = $('#form-expe_3').serialize();
            $.ajax({
                headers: {
