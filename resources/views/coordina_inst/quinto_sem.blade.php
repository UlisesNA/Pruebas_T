...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="quinto" role="tabpanel" aria-labelledby="quinto-tab">
                        <br>
                        <div class="form-group row">
                            <div class="col-sm-11" align="center"><h5>Planeación Quinto Semestre</h5></div>
                            <a class="btn btn-primary" data-toggle="modal" data-target="#myModal_5" style="background: #067a39;color: white">+</a>
                        </div>
                        <table class="table table-hover table-sm">
                            ...
                            @foreach ($planeacion as $plan)
                                @if($plan->id_semestre==5 && $plan->id_estado==0)
    ...
    <div class="modal fade" id="myModal_5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form id="form-expe_5">
                        ...
                        <div style="display: none">
                            <input type="number" class="form-control"  id="id_semestre" name="id_semestre" value="5">
                            <input type="number" class="form-control"  id="id_estado" name="id_estado" value="0">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <a class="btn btn-primary" id="final_5" data-dismiss="modal" style="color: white">Agregar</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        $('#final_5').click(function(){
            var con= true;
            var datos = $('#form-expe_5').serialize();
            $.ajax({
                headers: {
