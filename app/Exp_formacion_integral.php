...
class Exp_formacion_integral extends Model
{
    ...
    protected $fillable=["practica_deporte","especifica_deporte","practica_artistica","especifica_artistica","pasatiempo",
        ...
        "medicamento_controlado","especifica_medicamento","estatura","peso","accidente_grave","relata_breve","id_escala"];

    public function escala (){
        return $this->hasMany('App\Exp_escalas','id_escala','id_escala');
