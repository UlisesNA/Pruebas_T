...
class Exp_habitos_estudio extends Model
{
    ...
    protected $fillable=["tiempo_empelado_estudiar", "id_opc_intelectual","forma_estudio","tiempo_libre",
        "asignatura_preferida","porque_asignatura","asignatura_dificil","porque_asignatura_dificil","opinion_tu_mismo_estudiante"];
