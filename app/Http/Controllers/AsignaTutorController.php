    ...
    public function index(Request $request)
    {
        ...
        $noGrupo=DB::select('SELECT exp_asigna_generacion.id_asigna_generacion,exp_generacion.generacion,exp_generacion.id_generacion, exp_asigna_generacion.grupo
                              ...
                              from gnral_personales, exp_asigna_tutor,exp_asigna_generacion,exp_generacion where
                               ...
                               exp_asigna_generacion.id_generacion=exp_generacion.id_generacion and exp_asigna_tutor.deleted_at is null AND exp_asigna_tutor.id_jefe_periodo='.Session::get('id_jefe_periodo').') and exp_asigna_generacion.id='.Auth::user()->id.' ORDER BY exp_generacion.generacion');
