...
use App\actividades;
use App\Planeacion;
class Desarrollo_peticionesController extends Controller
{
    public function index(Request $request)
    {
        $s1=DB::select('SELECT gnral_semestres.descripcion, gnral_carreras.nombre, planeacion.desc_actividad,planeacion.sugerencia,planeacion.id_planeacion
                        ...
                        and planeacion.id_sugerencia=4
        ...
        return view('peticiones.peticiones',compact("s1","s2","s3","s4","s5","s6","s7","s8"));
    }
