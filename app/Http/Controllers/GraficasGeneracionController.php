...
class GraficasGeneracionController extends Controller
{
    ...
    public function generales(Request $request)
    {
        $estadogen=DB::select('SELECT (select COUNT(exp_generales.id_exp_general)
        			...
        			JOIN gnral_alumnos ON gnral_alumnos.id_alumno=exp_generales.id_alumno
                     JOIN exp_civil_estados ON exp_generales.id_estado_civil=exp_civil_estados.id_estado_civil 
                     WHERE  exp_generales.id_carrera='.$request->id_carrera.' AND SUBSTRING(gnral_alumnos.cuenta, 1, 4)='.$request->generacion.' AND exp_civil_estados.desc_ec="Divorsiado") as divorsiado,(select COUNT(exp_generales.id_exp_general)
                     FROM exp_generales 
        			JOIN gnral_alumnos ON gnral_alumnos.id_alumno=exp_generales.id_alumno
                     JOIN exp_civil_estados ON exp_generales.id_estado_civil=exp_civil_estados.id_estado_civil 
        ...
        $estadoF=DB::select('SELECT (select COUNT(exp_generales.id_exp_general)
        			 ...
        			 JOIN gnral_alumnos ON gnral_alumnos.id_alumno=exp_generales.id_alumno
                     JOIN exp_civil_estados ON exp_generales.id_estado_civil=exp_civil_estados.id_estado_civil 
                     WHERE  exp_generales.id_carrera='.$request->id_carrera.' AND SUBSTRING(gnral_alumnos.cuenta, 1, 4)='.$request->generacion.' AND exp_generales.sexo="F" AND exp_civil_estados.desc_ec="Divorsiado") as divorsiado,(select COUNT(exp_generales.id_exp_general)
                     FROM exp_generales
        			 JOIN gnral_alumnos ON gnral_alumnos.id_alumno=exp_generales.id_alumno
                     JOIN exp_civil_estados ON exp_generales.id_estado_civil=exp_civil_estados.id_estado_civil 
        ...
        $estadoM=DB::select('SELECT (select COUNT(exp_generales.id_exp_general)
        			 ...
        			 JOIN gnral_alumnos ON gnral_alumnos.id_alumno=exp_generales.id_alumno
                     JOIN exp_civil_estados ON exp_generales.id_estado_civil=exp_civil_estados.id_estado_civil 
                     WHERE  exp_generales.id_carrera='.$request->id_carrera.' AND SUBSTRING(gnral_alumnos.cuenta, 1, 4)='.$request->generacion.' AND exp_generales.sexo="M" AND exp_civil_estados.desc_ec="Divorsiado") as divorsiado,(select COUNT(exp_generales.id_exp_general)
                     FROM exp_generales
        			 JOIN gnral_alumnos ON gnral_alumnos.id_alumno=exp_generales.id_alumno
                     JOIN exp_civil_estados ON exp_generales.id_estado_civil=exp_civil_estados.id_estado_civil 
